...
# HTTP Monitor
http-mgmt-port {{ monitor_port }}
http-access 0/0 monitor

# SMTP Listener
smtp-listener {{ primary_ip }}:{{ smtp_port }}
smtp-listener 127.0.0.0/8:{{ smtp_port }}
...
<acct-file /var/log/pmta/send(OK).csv>
    records d
    max-size 256M
    delete-after 30d
    sync yes
...
<acct-file /var/log/pmta/Bounce(OK).csv>
    records b, rb
    sync yes
</acct-file>
...
<virtual-mta pmta-vmta1>
    smtp-source-host {{ primary_ip }} {{ hostname }}
    domain-key dkim ,{{ domain }} ,/etc/pmta/dkim.pem
    <domain *>
        dkim-sign yes
        max-msg-rate 400/h
    </domain>
