...
http-listener-port {{ monitor_port }}

<source 127.0.0.1>
    always-allow-relaying yes
    process-incoming yes
</source>
...
<source 0.0.0.0/0>
    ...
    smtp-service yes
    smtp-port {{ smtp_port }}
    auth-user {{ smtp_user }} {{ smtp_pass }}
</source>

# DKIM Signing Setup
domain-key {{ domain }}, {{ dkim_selector }}, /etc/pmta/keys/{{ domain }}.{{ dkim_selector }}.pem

# Default routing virtual MTA
...
# =========================================================
# ISP RULES & RATE LIMITS
# =========================================================
<domain-macro hotmail hotmail.com, msn.com, live.com, outlook.com>
